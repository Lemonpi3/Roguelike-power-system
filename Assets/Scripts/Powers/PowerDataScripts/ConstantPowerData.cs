...
public class ConstantPowerData : PowerData
{
    ...
    [field : SerializeField,Tooltip("Area position offset, by default is centered on charecter")] public Vector2 posOffSet {get; private set;}
    [field : SerializeField,Tooltip("Area rotation offset")] public Vector2 rotationOffSet {get; private set;}
